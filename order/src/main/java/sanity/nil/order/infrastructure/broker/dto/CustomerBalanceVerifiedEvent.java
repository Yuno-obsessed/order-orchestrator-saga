...
@ToString
public class CustomerBalanceVerifiedEvent implements Event, SagaEvent {
    ...
    public CustomerBalanceVerifiedEvent(UUID userID, UUID orderID,
                               EventStatus eventStatus, UUID sagaID) {
        this.payload = new Payload(orderID, userID);
        this.eventStatus = eventStatus;
        this.type = "CustomerBalanceVerified";
        this.sagaID = sagaID;
    }

    public CustomerBalanceVerifiedEvent(Payload payload, EventStatus eventStatus, String type, UUID sagaID) {
