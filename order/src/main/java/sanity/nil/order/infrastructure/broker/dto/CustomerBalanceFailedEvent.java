...
@ToString
public class CustomerBalanceFailedEvent implements Event, SagaEvent {
    ...
    public CustomerBalanceFailedEvent(Payload payload, EventStatus eventStatus, String type, UUID sagaID) {
